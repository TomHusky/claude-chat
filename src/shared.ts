...
export const ICONS: Record<string, string> = {
  ...
  thumbUp: _s('<path d="M5.5 7.2V13H3.6a.8.8 0 0 1-.8-.8V8a.8.8 0 0 1 .8-.8z"/><path d="M5.5 7.2l2.3-4.4a.9.9 0 0 1 1.7.5L9.2 6.4h2.9a1.1 1.1 0 0 1 1.08 1.33l-.8 3.9A1.1 1.1 0 0 1 11.3 12.5H5.5"/>'),
  thumbDown: _s('<path d="M5.5 8.8V3H3.6a.8.8 0 0 0-.8.8V8a.8.8 0 0 0 .8.8z"/><path d="M5.5 8.8l2.3 4.4a.9.9 0 0 0 1.7-.5L9.2 9.6h2.9a1.1 1.1 0 0 0 1.08-1.33l-.8-3.9A1.1 1.1 0 0 0 11.3 3.5H5.5"/>'),
};
